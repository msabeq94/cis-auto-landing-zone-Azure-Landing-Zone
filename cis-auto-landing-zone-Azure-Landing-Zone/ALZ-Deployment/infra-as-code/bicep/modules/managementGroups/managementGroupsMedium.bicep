...
metadata description = 'ALZ Bicep Module to set up Management Group structure for Medium Depoloyment Type'
...
resource resPlatformIdentityMg 'Microsoft.Management/managementGroups@2023-04-01' = {
...
output outPlatformIdentityGroupId string = resPlatformIdentityMg.id
...
output outPlatformIdentityGroupName string = resPlatformIdentityMg.name
